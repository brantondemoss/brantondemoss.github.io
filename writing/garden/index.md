...
- examples of pareto-improvement in agency. what would this look like for AI?
...
That statement certainly tells you a lot about the set of configurations “outside” could take on, but there’re lots of precise details about where exactly each raindrop is, that are left out. 
...
The internet is one of the most important examples of an abstraction that emerges from us. 
It’s easy to dismiss online spaces as less real than physical ones, but they’re just as real as water is wet, only defined over a higher abstraction. 
...
One reason it is difficult to consider digital spaces as real as physical ones is that they lack some properties we’re used to associating with interaction spaces, most notably locality.
Hooking fast computers up with high—speed internet has enabled patterns which exist distributed across many physical locations (e.g. the computers which run Instagram) to remain coherent. 
Much of who we are, our digital selves, exists non—locally. 
...
Morality is a briar patch, and I’d like very much to avoid getting trapped there. But consider: moral concepts can feel so subjective - who’s to say if what I want is right or wrong. 
Often different groups of people will have completely anti—aligned moral codes [citation needed]. It seems to be the job of politics to figure out the balance between different people’s rights and agency.
But when I look back on the past, to the Dark Ages, it really feels like we’ve made moral progress. And If I think to the future and look back to today, my bet is that there’s more progress to be made. 
How does that fit with completely subjective morality?

I believe the answer lies in improving agency!

Agency is fundamentally related to our ability to determine our futures, our own lives. 
Often our agency is bounded by others’ agency - my right to yell fire in a crowded room is limited by your right to safety. 
But I believe absolute improvements in agency are possible to achieve. Consider:
In the past, we all had to be farmers, there was simply no choice if you wanted to eat.
